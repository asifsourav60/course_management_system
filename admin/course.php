...
$ret=mysqli_query($con,"insert into course(courseCode,courseName,departmentName,noofSeats) values('$coursecode','$coursename','$departmentname','$seatlimit')");
if($ret)
{
 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                         <h4 class="page-head" style = "color: black;font-size:25px;text-align:center;">Add Course </h4>
					<hr/>
                    </div>
                </div>
                <div class="row" >
